  ...
  return (
    <div className="px-4 py-3.5 hover:bg-blue-50/40 active:bg-blue-50/60 transition flex items-center gap-3">
      ...
      <div className="flex gap-1.5 shrink-0">
        <button
          onClick={e => { e.stopPropagation(); onCall ? onCall(`+${lead.lead_phone}`) : window.location.href = `tel:+${lead.lead_phone}`; }}
          className="p-2.5 rounded-xl bg-blue-600 text-white active:bg-blue-700 transition touch-manipulation"
          title="Call"
        >
        ...
        <button
          onClick={e => { e.stopPropagation(); onSms?.(lead.id, lead.lead_phone); }}
          className="p-2.5 rounded-xl bg-emerald-600 text-white active:bg-emerald-700 transition touch-manipulation"
          title="SMS"
        >
